...
const Footer = () => {
    return (
        <footer className="footer   p-10 bg-base-200 text-primary">
  <div className=''>
    <img src='https://cdn.pixabay.com/photo/2017/07/25/15/25/w-2538524_960_720.png' alt='' className='w-20 h-50'></img>
    <p>WorkIn...<br/>Providing reliable jobs since 2021</p>
  </div> 
  <div>
